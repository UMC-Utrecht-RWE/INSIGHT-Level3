...
if(length(actual_tables$VACCINES)>0){
  ...
  vx_date_miss<-list() #number of record with missing date administration
  years<-list()
  ...
  vx_study_pop_obsper<-list() #number of records in the study population with date administration inside study period
  ######################
  ...
  ######################################################################################################################
  empty_atc_code<-list() #number of records with empty atc codes when date admin/record is present
  ...
  for (y in 1:length(actual_tables$VACCINES)){
    ...
    df<-df[study_population,on=.(person_id)]#left join, keeps all people in the study population even if they didn't have a administration
    df<-df[,age_start_follow_up:=as.numeric(age_start_follow_up)]
    pers_stdpop_not_vx<-df[rowSums(is.na(df[,..colnames]))==length(colnames), ..std_names] #subjects id present in the study population but that do not have a administration
    ...
    #number of records with both date administration missing
    ...
    empty_atc_code[[w]]<-df[is.na(vx_atc), .N] #number of records with missing atc code when date admin/record is present
    ...
    #records with missing atc code when date admin/record is present == empty_atc_code
  ...
  #################################################################################################  
  #number of subjects in the study population that do not have a administration/record
  ...
  #number of records in the study population with date administration inside study period (flowchart 6)
  ...
  description<-data.table(INDICATOR=c("List of meanings present",
                                      ...
                                      "Number of subjects without record/administrations in the study population",
  ...
  rm(description)
  #################################################################################################
  #Table 10: Number of administrations by ATC A level in the study population by year of record/admin and by meaning
  #################################################################################################
  print("Creating Table 10:  Number of administrations by ATC A level in the study population by year of record/admin and by meaning.")
  ...
  rm(tab10)
  #################################################################################################
  #Table 11: Number of administrations by ATC A level in the female study population of childbearing age 12-55 years (based on age at Start_study_fup) by year of record/admin and by meaning
  #################################################################################################
  ...
  if(females_childbearing>0){
    print("Creating Table 11:  Number of administrations by ATC A level in the female study population of childbearing age 12-55 years (based on age at Start_study_fup) by year of record/admin and by meaning.")
    print("Get all variables.")
  ...
  #Table 12:
  ##################################
  print("Creating Table 12:  Number of administrations by ATC 1, 3 and 4 level in the study population by year of record/admin and by meaning.")
  print("Get all variables.")
  ##############################
  ...
  if(male_population>0){
    ...
    if(length(median_males_files)>0){
      ...
      for (med_males_index in 1:length(list_median_males)){
        if(subpopulations_present=="Yes"){
          median_male<-readRDS(paste0(vaccines_pop, subpopulations_names[s], "/", list_median_males[[med_males_index]][1]))
        } else {
          median_male<-readRDS(paste0(vaccines_pop, list_median_males[[med_males_index]][1]))
        }
        ...
        while (z <= length(list_median_males[[med_males_index]])){
          if(subpopulations_present=="Yes"){
            a<-readRDS(paste0(vaccines_pop, subpopulations_names[s], "/", list_median_males[[med_males_index]][[z]]))
          } else {
            a<-readRDS(paste0(vaccines_pop, list_median_males[[med_males_index]][[z]]))
          }
        ...
        if(median_male[atc_level==7,.N]>0){
          ...
          saveRDS(res.tab13.m_records.my,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab13_m_rec_7.my_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab13.m_records.t,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab13_m_rec_7.t_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab13.m_users.c_7,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab13_m_users_7.my_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab13.m_users.t_7,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab13_m_users_7.t_", med_males_index, ".rds"))
          rm(res.tab13.m_users.t_7)
          #median administration by meaning, year and atc_code_7
          ...
          saveRDS(res.tab13.m_users.med_7,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab13_m_median_7.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab13.m_users.med.t_7,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab13_m_median_7.t_",med_males_index, ".rds"))
          rm(res.tab13.m_users.med.t_7)
          
          #mean administration by meaning, year and atc_code_7
          ...
          saveRDS(res.tab13.m_users.mean_7,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab13_m_mean_7.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab13.m_users.mean.t_7,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab13_m_mean_7.t_",med_males_index, ".rds"))
        ...
        if(median_male[atc_level==4|atc_level==5|atc_level==6|atc_level==7,.N]>0){
          ...
          saveRDS(res.tab12.m_records.my,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_rec_4.my_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_records.t,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_rec_4.t_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.c_4,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_users_4.my_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.t_4,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_users_4.t_", med_males_index, ".rds"))
          rm(res.tab12.m_users.t_4)
          #median administration by meaning, year and atc_code_4
          ...
          saveRDS(res.tab12.m_users.med_4,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_median_4.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.med.t_4,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_median_4.t_",med_males_index, ".rds"))
          rm(res.tab12.m_users.med.t_4)
          
          #mean administration by meaning, year and atc_code_4
          ...
          saveRDS(res.tab12.m_users.mean_4,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_mean_4.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.mean.t_4,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_mean_4.t_",med_males_index, ".rds"))
        ...
        if(median_male[atc_level==3,.N]>0){
          ...
          saveRDS(res.tab12.m_records.my,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_rec_3.my_", med_males_index, ".rds"))
          rm(res.tab12.m_records.my)
          ...
          saveRDS(res.tab12.m_records.t,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_rec_3.t_", med_males_index, ".rds"))
          rm(res.tab12.m_records.t)
          ...
          saveRDS(res.tab12.m_users.c_3,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_users_3.my_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.t_3,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_users_3.t_", med_males_index, ".rds"))
          rm(res.tab12.m_users.t_3)
          #median administration by meaning, year and atc_code_3
          ...
          saveRDS(res.tab12.m_users.med_3,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_median_3.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.med.t_3,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_median_3.t_",med_males_index, ".rds"))
          rm(res.tab12.m_users.med.t_3,res.tab12.m)
          
          #mean administration by meaning, year and atc_code_3
          ...
          saveRDS(res.tab12.m_users.mean_3,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_mean_3.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.mean.t_3,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_mean_3.t_",med_males_index, ".rds"))
        ...
        if(median_male[atc_level==1,.N]>0){
          ...
          saveRDS(res.tab12.m_records.my,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_rec_1.my_", med_males_index, ".rds"))
          rm(res.tab12.m_records.my)
          ...
          saveRDS(res.tab12.m_records.t,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_rec_1.t_", med_males_index, ".rds"))
          rm(res.tab12.m_records.t)
          ...
          saveRDS(res.tab12.m_users.c_1,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_users_1.my_", med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.t_1,paste0(vaccines_tmp,names(list_median_males)[med_males_index], "_tab12_m_users_1.t_", med_males_index, ".rds"))
          rm(res.tab12.m_users.t_1)
          #median administration by meaning, year and atc_code_1
          ...
          saveRDS(res.tab12.m_users.med_1,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_median_1.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.med.t_1,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_median_1.t_",med_males_index, ".rds"))
          rm(res.tab12.m_users.med.t_1,res.tab12.m)
          
          #mean administration by meaning, year and atc_code_1
          ...
          saveRDS(res.tab12.m_users.mean_1,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_mean_1.my_",med_males_index, ".rds"))
          ...
          saveRDS(res.tab12.m_users.mean.t_1,paste0(vaccines_tmp,names(list_median_males)[med_males_index],"_tab12_m_mean_1.t_",med_males_index, ".rds"))
          rm(res.tab12.m_users.mean.t_1,res.tab12.m)
          median_male[,atc_code_1:=NULL]
        }
      }
      print("Calculating number of male users and number of median administration/dispensings stratified by ATC code, meaning and year.")
      rm(median_male)
      ########
      #Info input
      ...
      print("Calculating total number of male users and number of median administration/dispensings stratified by ATC code.")
      ########
      #total
      ########
      #combine results for male users records
  ...
  if(female_population>0){
    ...
    if(length(median_females_files)>0){
      ...
      for (med_females_index in 1:length(list_median_females)){
        if (subpopulations_present=="Yes"){
          median_female<-readRDS(paste0(vaccines_pop, subpopulations_names[s], "/", list_median_females[[med_females_index]][1]))
        } else {
          median_female<-readRDS(paste0(vaccines_pop, list_median_females[[med_females_index]][1]))
        ...
        while (z <= length(list_median_females[[med_females_index]])){
          if(subpopulations_present=="Yes"){
            a<-readRDS(paste0(vaccines_pop, subpopulations_names[s], "/", list_median_females[[med_females_index]][[z]]))
          } else {
            a<-readRDS(paste0(vaccines_pop, list_median_females[[med_females_index]][[z]]))
          }
        ...
        if(median_female[atc_level==7,.N]>0){
          ...
          saveRDS(res.tab13.f_records.my,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab13_f_rec_7.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_records.t,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab13_f_rec_7.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_users.c_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab13_f_users_7.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_users.t_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab13_f_users_7.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_users.med_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab13_f_median_7.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_users.med.t_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab13_f_median_7.t_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_users.mean_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab13_f_mean_7.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab13.f_users.mean.t_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab13_f_mean_7.t_",med_females_index, ".rds"))
        ...
        if(median_female[atc_level==7 & age_start_follow_up>=min_age_preg & age_start_follow_up<=max_age_preg,.N]>0){
          ...
          saveRDS(res.tab12.f_records.my,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab14_f_rec_7.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_records.t,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab14_f_rec_7.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.c_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab14_f_users_7.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.t_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab14_f_users_7.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab14_f_median_7.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med.t_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab14_f_median_7.t_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab14_f_mean_7.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean.t_7,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab14_f_mean_7.t_",med_females_index, ".rds"))
        ...
        if(median_female[atc_level>=4,.N]>0){
          ...
          saveRDS(res.tab12.f_records.my,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_rec_4.my_", med_females_index, ".rds"))
          rm(res.tab12.f_records.my)
          #number of records by atc_code_4
          ...
          saveRDS(res.tab12.f_records.t,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_rec_4.t_", med_females_index, ".rds"))
          rm(res.tab12.f_records.t)
          ...
          saveRDS(res.tab12.f_users.c_4,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_users_4.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.t_4,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_users_4.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med_4,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_median_4.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med.t_4,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_median_4.t_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean_4,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_mean_4.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean.t_4,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_mean_4.t_",med_females_index, ".rds"))
        ...
        if(median_female[atc_level==3,.N]>0){
          ...
          saveRDS(res.tab12.f_records.my,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_rec_3.my_", med_females_index, ".rds"))
          rm(res.tab12.f_records.my)
          #number of records by atc_code_3
          ...
          saveRDS(res.tab12.f_records.t,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_rec_3.t_", med_females_index, ".rds"))
          rm(res.tab12.f_records.t)
          ...
          saveRDS(res.tab12.f_users.c_3,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_users_3.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.t_3,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_users_3.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med_3,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_median_3.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med.t_3,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_median_3.t_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean_3,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_mean_3.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean.t_3,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_mean_3.t_",med_females_index, ".rds"))
        ...
        if(median_female[atc_level==1,.N]>0){
          ...
          saveRDS(res.tab12.f_records.my,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_rec_1.my_", med_females_index, ".rds"))
          rm(res.tab12.f_records.my)
          #number of records by atc_code_1
          ...
          saveRDS(res.tab12.f_records.t,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_rec_1.t_", med_females_index, ".rds"))
          rm(res.tab12.f_records.t)
          ...
          saveRDS(res.tab12.f_users.c_1,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_users_1.my_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.t_1,paste0(vaccines_tmp,names(list_median_females)[med_females_index], "_tab12_f_users_1.t_", med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med_1,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_median_1.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.med.t_1,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_median_1.t_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean_1,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_mean_1.my_",med_females_index, ".rds"))
          ...
          saveRDS(res.tab12.f_users.mean.t_1,paste0(vaccines_tmp,names(list_median_females)[med_females_index],"_tab12_f_mean_1.t_",med_females_index, ".rds"))
          rm(res.tab12.f_users.mean.t_1)
          median_female[,atc_code_1:=NULL]
        }
      }
      rm(median_female)
      print("Calculating number of female users and number of median administration/dispensings stratified by ATC code, meaning and year.")
      ...
      print("Calculating total number of female users and number of median administration/dispensings stratified by ATC code.")
      ########
      #total
      ########
      #combine results for female users records
  ...
  rm(tab12)
  #########################################
  #Table 13:Number of administrations by ATC 3 & 7 level in the study population by year of record/admin and by meaning for each ATC class
  #########################################
  print("Creating Table 13:Number of administrations by ATC 3 & 7 level in the study population by year of record/admin and by meaning for each ATC class.")
  print("Get all variables.")
  ########
  #Info input
  ...
  #########
  print("Calculating number of male users and number of median administration/dispensings stratified by ATC code level 7, meaning and year.")
  #######
  #males
  ######
  #######
  ...
  if(female_population>0){
    ...
    tab13.med.f<-rbind(readRDS(paste0(vaccines_tmp,"tab13.f_median.my.rds")),readRDS(paste0(vaccines_tmp,"tab13.f_median.t.rds")))
  ...
  if(male_population>0){
    ...
    tab13.med.m<-rbind(readRDS(paste0(vaccines_tmp,"tab13.m_median.my.rds")),readRDS(paste0(vaccines_tmp,"tab13.m_median.t.rds")))
  ...
  rm(tab13)
  #########################################
  #Table 14:Number of administrations by ATC 3 & 7 level in the study population by year of record/admin and by meaning for each ATC class
  #########################################
  print("Creating table 14: Number of administrations by ATC 3 & 7 level in the study population by year of record/admin and by meaning for females of childbearing age (12-55 age_start_fup).")
  print("Get all variables.")
  if(females_childbearing>0){
    ########
    #Info input
  ...
  rm(empty_atc_code_m, empty_atc_code_m_f, empty_atc_code_m_y, empty_atc_code_m_y_f,
     vx_study_population_f, vx_study_population_meaning, vx_study_population_meaning_f, years_this_table)
  ########################################################################################################
  ...
  ####################################
  #Calculate person time for all subjects that never had a administration(are part of study population but not the medicicines_study_population)
  ####################################
  med_no_rx_files<-list.files(vaccines_tmp, "vx_id_no_rx.rds")
