...
subtitle: "GDPR: Medicine use in pregnancy"
output: 
  html_document:
    theme: spacelab
    toc: true
...
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_med_prior_removed.csv"))>0){
...
datatable(res_med, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data or there were no exclusions.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_med_prior_removed.csv"))>0){
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_med_prevalence_atc_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_4, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_med_prevalence_atc_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_med_prevalence_s_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_4, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_med_prevalence_s_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_med_prevalence_y_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_5, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_med_prevalence_y_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_med_counts_ys_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_6, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_med_counts_ys_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_med_counts_ym_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_6, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_med_counts_ym_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_MEDICINES/",subpopulations_names[a], "/GDPR/")
