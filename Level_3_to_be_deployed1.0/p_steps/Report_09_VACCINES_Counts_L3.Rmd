...
subtitle: "Counts of vaccine exposure in the study population"
output: 
  html_document:
    theme: spacelab
    toc: true
...
if (subpopulations_present=="No"){
  if(length(list.files(paste0(vacc_dir,"Masked/"), pattern="vaccines_my_atc_1_masked.csv"))>0){
tab10_vx<-fread(paste0(vacc_dir,"Masked/", list.files(paste0(vacc_dir,"Masked/"), pattern="vaccines_my_atc_1_masked.csv")))
if(tab10_vx[,.N]>0){
setcolorder(tab10_vx,c("vaccine_indicator","year", "count","total", "meaning",  "data_access_provider", "data_source"))
 if(tab10_vx[,.N]>12000){
...
datatable(head(tab10_vx,12000), options = list(scrollX=T))
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(vacc_dir,subpopulations_names[a], "/Masked/"), pattern="vaccines_my_atc_1_masked.csv"))>0){
  tab10_vx<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", list.files(paste0(vacc_dir,subpopulations_names[a], "/Masked/"), pattern="vaccines_my_atc_1_masked.csv")))
  if (tab10_vx[,.N]>0){
...
if (subpopulations_present=="No"){
  if(length(list.files(paste0(vacc_dir,"Masked/"), pattern="vaccines_my_atc_4_masked.csv"))>0){
tab12_vx<-fread(paste0(vacc_dir,"Masked/", list.files(paste0(vacc_dir,"Masked/"), pattern="vaccines_my_atc_4_masked.csv")))
if(tab12_vx[,.N]>0){
  if(tab12_vx[,.N]>12000){
...
datatable(tab12_vx, options = list(scrollX=T))
  ...
  tab12_vx<-NULL
    ...
    if(length(list.files(paste0(vacc_dir,subpopulations_names[a], "/Masked/"), pattern="vaccines_my_atc_4_masked.csv"))>0){
  tab12_vx<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", list.files(paste0(vacc_dir,subpopulations_names[a], "/Masked/"), pattern="vaccines_my_atc_4_masked.csv")))
  if(tab12_vx[,.N]>0){
if(tab12_vx[,.N]>12000){
      print("If the table contanins more than 12000 records it can not be displayed in the report. For the complete table, go to g_output/VACCINES/vaccines_my_atc_4_masked.csv")
    datatable(head(tab12_vx,12000), options = list(scrollX=T))
...
if (subpopulations_present=="No"){
  if(length(list.files(paste0(vacc_dir,"Masked/"), pattern="vaccines_my_atc_7_masked.csv"))>0){
tab13_vx<-fread(paste0(vacc_dir,"Masked/", list.files(paste0(vacc_dir,"Masked/"), pattern="vaccines_my_atc_7_masked.csv")))
...
if(tab13_vx[,.N]>0){
  ...
  tab13_vx<-NULL
    ...
    if(length(list.files(paste0(vacc_dir,subpopulations_names[a], "/Masked/"), pattern="vaccines_my_atc_7_masked.csv"))>0){
  tab13_vx<-fread(paste0(vacc_dir,subpopulations_names[a], "/Masked/", list.files(paste0(vacc_dir,subpopulations_names[a], "/Masked/"), pattern="vaccines_my_atc_7_masked.csv")))
  if(tab13_vx[,.N]>0){
