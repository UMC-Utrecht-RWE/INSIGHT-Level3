...
if (tab15_med[,.N]>0){
  if (tab15_med[,.N]>12000){
    ...
    datatable(head(tab15_med,12000), options = list(scrollX=T), filter = "top")
  } else {
...
datatable(head(tab16_med,12000), options = list(scrollX=T), filter = "top")
  } else {
datatable(tab16_med, options = list(scrollX=T), filter = "top")  
  }
} else {
    tab16_med<-NULL
    print("This table cannot be produced based on the available data.")
