...
subtitle: "GDPR: Vaccine exposure in pregnancy"
output: 
  html_document:
    theme: spacelab
    toc: true
...
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_prior_removed.csv"))>0){
...
datatable(res_vacc, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_prior_removed.csv"))>0){
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_dup_removed.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_vacc_2, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_dup_removed.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a],"/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_summary_m_masked.csv"))>0){
res<-fread(paste0(poi_dir,"GDPR/", list.files(paste0(poi_dir,"GDPR/"),"preg_summary_m_masked.csv")))
if(res[,.N]>0){
datatable(res, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,subpopulations_names[a], "/GDPR/"), pattern="preg_summary_m_masked.csv"))>0){
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_prevalence_atc_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_4, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_prevalence_atc_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_prevalence_s_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_4, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_prevalence_s_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_prevalence_y_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_5, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_prevalence_y_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_counts_ys_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_6, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_counts_ys_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/")
...
```{r echo=F, warning=FALSE}
if (subpopulations_present=="No"){
  if(length(list.files(paste0(poi_dir,"GDPR/"), pattern="preg_vacc_counts_ym_masked.csv"))>0){
fl<-paste0(poi_dir,"GDPR/")
...
datatable(res_6, options = list(scrollX=T), filter="top")
  ...
  print("This table cannot be produced based on the available data.")
    ...
    if(length(list.files(paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/"), pattern="preg_vacc_counts_ym_masked.csv"))>0){
      fl<-paste0(poi_dir,"PREGNANCY_VACCINES/",subpopulations_names[a], "/GDPR/")
