...
subtitle: "Description of the population and follow-up times"
output: 
  html_document:
    theme: spacelab
    toc: true
...
file<-list.files(paste0(std_source_pop_dir,"Masked/"),"R_01_01_POPTREE.csv")
...
datatable(TEMP, options = list(scrollX=T), colnames = c('Number of females' = 'F', 'Number of males' = 'M'))
} else {
