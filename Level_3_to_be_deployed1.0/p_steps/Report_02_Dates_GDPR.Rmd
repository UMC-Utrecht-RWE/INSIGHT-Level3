...
subtitle: "GDPR: Dates distribution"
output: 
  html_document:
    theme: spacelab
    toc: true
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_0608_DT_start_follow_up.csv")
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_0608_DT_op_start_date.csv")
TEMP <- fread(paste0(std_source_pop_dir,"GDPR/",file), sep = ";")  
...
```{r echo=F,fig.width=9,fig.height=5}
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_0608_DT_end_follow_up.csv")
TEMP <- fread(paste0(std_source_pop_dir,"GDPR/",file), sep = ";")  
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_0608_DT_op_end_date.csv")
TEMP <- fread(paste0(std_source_pop_dir,"GDPR/",file), sep = ";")  
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_0608_DT_birth_date.csv")
TEMP <- fread(paste0(std_source_pop_dir,"GDPR/",file), sep = ";")  
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_09_DT_birth_date_day.csv")
TEMP <- fread(paste0(std_source_pop_dir,"GDPR/",file), sep = ";")  
