...
for(i in 1:nrow(SCHEME_0112)){
  ...
  COUNT <- COUNT[, NoPY := round(No/(PY2/365.25)*100,2)]
  ...
  new <- c("Calendar year","Age","PY","Visit meaning","No. of visits","No. of persons with at least one visit","Visit rate, No. of visits/100 PY")
