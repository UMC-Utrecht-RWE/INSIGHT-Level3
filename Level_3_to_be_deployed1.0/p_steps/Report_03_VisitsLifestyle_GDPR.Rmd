...
subtitle: "GDPR: Lifestyle and visits"
output: 
  html_document:
    theme: spacelab
    toc: true
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_12_VISITS.csv")
...
datatable(TEMP, options = list(scrollX=T), rownames = F, filter = "top")
...
file<-list.files(paste0(std_source_pop_dir,"GDPR/"),"R_01_13_LIFESTYLE.csv")
TEMP <- fread(paste0(std_source_pop_dir,"GDPR/",file), sep = ";")[, Order := NULL]
